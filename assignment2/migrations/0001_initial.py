    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobby', models.ManyToManyField(to='assignment2.hobby', verbose_name='취미')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='assignment2.user', verbose_name='사용자')),
            ],
        ),
    ]
